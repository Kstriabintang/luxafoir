...
export function OrderConfirmation() {
  ...
  return (
    <div className="mx-auto flex max-w-xl flex-col items-center px-site py-32 text-center">
      ...
      >
        <h1 className="mt-10 font-display text-h1 font-light text-ivory">Order Confirmed</h1>
        <p className="mt-4 text-body text-mist">
          Thank you for your order. We&apos;ve sent a confirmation to your email and are
